...
/* ── Divider ── */
.h-line { border: none; border-top: 1px solid var(--border); margin: 5rem 0; }
...
.proj-idx {
  font-family: var(--mono); font-size: 0.65rem; color: var(--subtle);
  padding-top: 0.25rem; letter-spacing: 1px;
...
.proj-desc {
  ...
  margin-bottom: 0.85rem; max-width: 680px;
}
...
.proj-link {
  ...
  transition: color 0.2s; flex-shrink: 0; margin-left: 1rem;
}
...
.exp-points li::before { content: '—'; position: absolute; left: 0; color: var(--subtle); }
.exp-badge {
...
.exp-cgpa {
  ...
  font-family: var(--mono); font-size: 0.7rem;
  color: var(--accent2); border: 1px solid rgba(200,169,110,0.25);
...
.quote-mark {
  ...
  color: var(--border2); display: block; margin-bottom: 1.5rem;
}
.quote-body {
  font-family: var(--serif); font-style: italic;
  font-size: clamp(1rem, 2vw, 1.2rem); line-height: 2;
  color: var(--muted); max-width: 480px; margin: 0 auto 1rem;
}
...
.foot-links a {
  ...
  color: var(--subtle); text-decoration: none; text-transform: uppercase;
  transition: color 0.2s;
}
      ...
      <div class="hero-side reveal">
        <ul class="hero-meta-list">
          <li>
            ...
            <span class="meta-val">Backend / AI Dev</span>
          </li>
          <li>
            <span class="meta-key">Status</span>
            <span class="meta-val green">Open to work</span>
          </li>
          <li>
            <span class="meta-key">Location</span>
            <span class="meta-val">Mumbai, India</span>
          </li>
          <li>
            <span class="meta-key">CGPA</span>
            <span class="meta-val">7.5 / 10</span>
          </li>
          <li>
            <span class="meta-key">Batch</span>
            <span class="meta-val">2027</span>
          </li>
          <li>
            <span class="meta-key">Internship</span>
            <span class="meta-val">Innovexis · Apr 2026</span>
          </li>
        </ul>
      </div>
    </div>
...
<div class="wrap">
  <div class="stats-row reveal">
    ...
    <div class="stat">
      <div class="stat-n">7<em>.</em>5</div>
      <div class="stat-l">CGPA</div>
    </div>
    <div class="stat">
      <div class="stat-n">3<em>rd</em></div>
      <div class="stat-l">Year B.Tech</div>
    </div>
    <div class="stat">
      <div class="stat-n">1</div>
      <div class="stat-l">Internship</div>
    </div>
  </div>
</div>
  ...
  <div class="wrap">
    ...
    <div class="exp-grid reveal">
      ...
      <div class="exp-card">
        ...
        <div class="exp-badge">
          <div class="nav-dot" style="width:5px;height:5px;"></div>
          Currently Active
        </div>
      </div>
...
<footer>
  <div class="foot-inner">
    <div class="foot-copy">
      Built by <a href="https://github.com/Shravan157">Shravan Parthe</a> · 2026
    </div>
